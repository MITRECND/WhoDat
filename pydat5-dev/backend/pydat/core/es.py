...
def cluster_stats():
    ...
    stats = _process_cluster_stats_results(results)
...
def data_table_search(key, value, skip, pagesize, sortset, sfilter, low, high):
    ...
    query = _create_data_table_search_query(key, value, skip, pagesize, sortset, sfilter, low, high)
...
def search(key, value, filt=None, limit=10000, low=None, high=None, versionSort=False):
...
def _process_search_query_results(domains):
    """
    Raises:
        RuntimeError
    """
...
def _process_advanced_search_results(domains, skip, size, unique):
    """
...
def _process_cluster_stats_results(results):
...
def _create_data_table_search_query(key, value, skip, pagesize, sortset, sfilter, low, high):
    """ """
    query_filter = {"term": {key: value}}
    final_filter = [query_filter]
    version_filter = None
...
def _process_data_table_search_results(domains):
    results = {}
    results["aaData"] = []
