...
urlpatterns = [
  ...
  url(r'^pdnsr_results/(?P<search_value>.*)/$',
  ...
  url(r'^ajax/domain/(?P<domainName>.*)/diff/(?P<v1>.*)/(?P<v2>.*)/$',
      ajax.domain_diff),
  url(r'^ajax/domain/(?P<domainName>.*)/(?P<low>.*)/(?P<high>.*)/$',
      ajax.domain),
  ...
  url(r'^ajax/domains/(?P<key>.*)/(?P<value>.*)/(?P<low>.*)/(?P<high>.*)/$',
      ajax.domains),
  url(r'^ajax/domains/(?P<key>.*)/(?P<value>.*)/latest/$',
      ajax.domains_latest),
  url(r'^ajax/domains/(?P<key>.*)/(?P<value>.*)/(?P<low>.*)/$',
      ajax.domains),
