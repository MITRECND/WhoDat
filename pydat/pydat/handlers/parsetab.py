...
_lr_productions = [
  ...
  ('query -> LPAREN query RPAREN','query',3,'p_query_group','advanced_es.py',262),
  ('query -> NOT query','query',2,'p_query_not','advanced_es.py',266),
  ('query -> query query','query',2,'p_query_query','advanced_es.py',286),
  ('query -> query AND query','query',3,'p_query_and_query','advanced_es.py',290),
  ('query -> query OR query','query',3,'p_query_or_query','advanced_es.py',295),
  ('query -> specific','query',1,'p_query_terminals','advanced_es.py',309),
  ('query -> daterange','query',1,'p_query_terminals','advanced_es.py',310),
  ('query -> termquery','query',1,'p_query_terminals','advanced_es.py',311),
  ('specific -> FUZZY WORD COLON WORD','specific',4,'p_specific_fuzzy_word','advanced_es.py',346),
  ('specific -> WORD COLON WORD','specific',3,'p_specific_word','advanced_es.py',362),
  ('specific -> FUZZY WORD COLON QUOTED','specific',4,'p_specific_fuzzy_quoted','advanced_es.py',373),
  ('specific -> WORD COLON QUOTED','specific',3,'p_specific_quoted','advanced_es.py',418),
  ('specific -> WORD COLON NULL','specific',3,'p_field_missing','advanced_es.py',477),
  ('specific -> WORD COLON WILDCARD','specific',3,'p_specific_wildcard','advanced_es.py',547),
  ('specific -> WORD COLON REGEX','specific',3,'p_specific_regex','advanced_es.py',555),
  ('daterange -> WORD COLON DATE','daterange',3,'p_daterange_single','advanced_es.py',585),
  ('daterange -> WORD COLON DATE COLON DATE','daterange',5,'p_daterange_range','advanced_es.py',597),
  ('termquery -> QUOTED','termquery',1,'p_termquery_quoted','advanced_es.py',611),
  ('termquery -> WORD','termquery',1,'p_termquery_word','advanced_es.py',660),
]
